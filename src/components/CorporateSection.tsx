...
export const CorporateSection: React.FC = () => {
  ...
  return (
    <section id="corporate" className="py-16 bg-[#FAF5EC] text-[#29180E] relative border-b border-[#EADCC8]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="inline-flex items-center space-x-2 text-xs font-semibold tracking-wider text-[#9A3412] bg-[#FEE2E2]/60 px-3.5 py-1 rounded-full border border-[#FCA5A5]/60 mb-2.5">
            ...
            <span>Corporate Events & Meets • The Aura</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-10">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-xl overflow-hidden shadow-md border-2 border-[#D97706]/40 bg-[#2A1004]">
              <img
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {corporateFeatures.map((feat, i) => {
                ...
                return (
                  <div key={i} className="p-3.5 bg-white rounded-lg border border-[#E8D8C3] shadow-xs">
                    <div className="w-7 h-7 rounded-md bg-[#FFF7ED] text-[#C2410C] flex items-center justify-center mb-1.5">
                      <Icon className="w-4 h-4" />
                    </div>
                    <h4 className="font-serif font-bold text-xs text-[#451A03] mb-0.5">{feat.title}</h4>
                    <p className="text-[11px] text-stone-600 leading-normal">{feat.desc}</p>
                  </div>
                );
              })}
            </div>
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center space-x-2 px-5 py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold transition-all shadow-xs"
              >
        ...
        {/* Seating Layouts */}
        <div className="bg-white rounded-xl p-5 sm:p-6 border border-[#E8D8C3] shadow-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {layouts.map((layout, idx) => (
              <div key={idx} className="p-3 rounded-lg bg-[#FAF5EC] border border-[#E8D8C3] flex flex-col justify-between">
                <div>
                ...
                <div className="mt-2 pt-1 border-t border-stone-200 text-[10px] font-semibold text-emerald-700 flex items-center space-x-1">
