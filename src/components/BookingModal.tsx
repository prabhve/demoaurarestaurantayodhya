...
export const BookingModal: React.FC<BookingModalProps> = ({ isOpen, initialType, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fadeIn">
      <div className="bg-[#1C1917] text-[#FAF7F2] max-w-lg w-full rounded-2xl overflow-hidden shadow-2xl border border-[#C5A059]/40 flex flex-col">
        
        {/* Header */}
        <div className="px-6 py-4 bg-[#24201E] flex items-center justify-between border-b border-stone-800">
          <div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-[#292524] border border-stone-700 rounded-lg text-xs sm:text-sm text-stone-200 focus:outline-none focus:ring-1 focus:ring-[#C5A059]"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-[#292524] border border-stone-700 rounded-lg text-xs text-stone-200 focus:outline-none focus:ring-1 focus:ring-[#C5A059]"
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2 bg-[#292524] border border-stone-700 rounded-lg text-xs text-stone-200 focus:outline-none focus:ring-1 focus:ring-[#C5A059]"
            />
          </div>
          ...
          <div className="pt-3">
            <button
              type="submit"
              className="w-full py-3 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs sm:text-sm flex items-center justify-center space-x-2 transition-all shadow-md cursor-pointer"
            >
