...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-16 bg-[#FDF9F3] text-[#29180E] relative border-b border-[#EADCC8]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="inline-flex items-center space-x-2 text-xs font-semibold tracking-wider text-[#9A3412] bg-[#FEE2E2]/60 px-3.5 py-1 rounded-full border border-[#FCA5A5]/60 mb-2.5">
            ...
            <span>अयोध्या की परंपरा एवं पवित्रता • Our Heritage</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-4 rounded-lg bg-white border border-[#E8D8C3] shadow-xs hover:border-[#D97706] transition-colors">
                <div className="w-8 h-8 rounded-md bg-[#FFF7ED] text-[#C2410C] flex items-center justify-center mb-2 font-bold">
                  🪔
                </div>
                <h3 className="font-serif font-bold text-base text-[#451A03] mb-1">
              ...
              <div className="p-4 rounded-lg bg-white border border-[#E8D8C3] shadow-xs hover:border-[#D97706] transition-colors">
                <div className="w-8 h-8 rounded-md bg-[#ECFDF5] text-emerald-700 flex items-center justify-center mb-2 font-bold">
                  🌿
                </div>
                <h3 className="font-serif font-bold text-base text-[#451A03] mb-1">
              ...
              <div className="p-4 rounded-lg bg-white border border-[#E8D8C3] shadow-xs hover:border-[#D97706] transition-colors">
                <div className="w-8 h-8 rounded-md bg-[#FEF3C7] text-[#B45309] flex items-center justify-center mb-2 font-bold">
                  🏛️
                </div>
                <h3 className="font-serif font-bold text-base text-[#451A03] mb-1">
                  On Ram Path Road
              ...
              <div className="p-4 rounded-lg bg-white border border-[#E8D8C3] shadow-xs hover:border-[#D97706] transition-colors">
                <div className="w-8 h-8 rounded-md bg-[#EFF6FF] text-[#1D4ED8] flex items-center justify-center mb-2 font-bold">
                  🎊
                </div>
                <h3 className="font-serif font-bold text-base text-[#451A03] mb-1">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <a
                ...
                className="px-4 py-2.5 rounded-md bg-[#451A03] hover:bg-[#5C2304] text-[#FEF3C7] text-xs font-semibold flex items-center space-x-2 transition-colors"
              >
