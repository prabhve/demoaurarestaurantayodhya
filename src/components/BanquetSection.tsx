...
export const BanquetSection: React.FC<BanquetSectionProps> = ({ onOpenBookingModal }) => {
  return (
    <section id="banquet" className="py-12 sm:py-16 bg-[#240E03] text-[#FFFDF9] relative border-b border-[#3E1A08]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
          <div className="inline-flex items-center space-x-1.5 sm:space-x-2 text-[11px] sm:text-xs font-semibold tracking-wider text-[#FDE68A] bg-[#451A03] px-3.5 py-1 rounded-full border border-[#D97706]/40 mb-2.5 max-w-full">
            <Sparkles className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
            <span className="truncate">उत्सव एवं मांगलिक आयोजन • Celebrations in Ayodhya</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-[#331405] rounded-2xl overflow-hidden border border-[#D97706]/40 shadow-md flex flex-col justify-between">
            <div>
              ...
              <div className="p-4 sm:p-5">
                <div className="text-[11px] sm:text-xs font-semibold text-[#F59E0B] uppercase tracking-wider mb-1">
                  Centralized AC Hall
                </div>
                <h3 className="font-serif text-lg sm:text-xl font-bold text-[#FEF3C7] mb-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-amber-200/90 mb-4">
                  <div className="flex items-center space-x-1.5">
                    ...
                    <span className="text-[11px] sm:text-xs">Centralized AC</span>
                  </div>
                  <div className="flex items-center space-x-1.5">
                    <Check className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
                    <span className="text-[11px] sm:text-xs">Pure Veg Catering</span>
                  </div>
                  <div className="flex items-center space-x-1.5">
                    <Check className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
                    <span className="text-[11px] sm:text-xs">Stage & Sound</span>
                  </div>
                  <div className="flex items-center space-x-1.5">
                    <Check className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
                    <span className="text-[11px] sm:text-xs">Dedicated Staff</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="p-3.5 sm:p-4 bg-[#291004] border-t border-amber-900/60 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
              <span className="text-xs text-amber-300/80 font-medium text-center sm:text-left">
                50 to 200 Guests
              </span>
              <a
                ...
                className="w-full sm:w-auto min-h-[42px] px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold flex items-center justify-center space-x-1.5 transition-colors active:scale-98 shadow-xs"
              >
            ...
            <div>
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-amber-200/90 mb-4">
                  <div className="flex items-center space-x-1.5">
                    <Check className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
                    <span className="text-[11px] sm:text-xs">Landscaped Lawn</span>
                  </div>
                  <div className="flex items-center space-x-1.5">
                    <Check className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
                    <span className="text-[11px] sm:text-xs">Live Food Counters</span>
                  </div>
                  <div className="flex items-center space-x-1.5">
                    <Check className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
                    <span className="text-[11px] sm:text-xs">Bridal Rooms</span>
                  </div>
                  <div className="flex items-center space-x-1.5">
                    <Check className="w-3.5 h-3.5 text-[#F59E0B] flex-shrink-0" />
                    <span className="text-[11px] sm:text-xs">Valet Parking</span>
                  </div>
                </div>
              </div>
            </div>
